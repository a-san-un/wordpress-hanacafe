...
| 13-2 | Google Search Console — カバレッジエラー0件を確認 | 🔲 |
| 13-3 | robots.txt が本番で正しく配信されているか確認・対応 | 🔲 |
| 13-4 | GSC で noindex 5ページが意図通り除外されているか確認 | 🔲 |
...
| STEP | 件数 | 状態 |
| ---- | ---- | ---- |
| STEP 12 docs整理 | 6件 | 1件完了・5件残 |
| STEP 13 公開後モニタリング | 7件 | 3件完了・4件残 |
