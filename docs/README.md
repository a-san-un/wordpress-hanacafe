...
wordpress-hanacafe/
├── docs/                              # 設計・運用ドキュメント群
│   ├── HanaCAFE nappa69 プロジェクト仕様書.md  # ★ SSOT（v1.3.0）
...
| ファイル | 内容 | バージョン |
|---|---|---|
| [HanaCAFE nappa69 プロジェクト仕様書.md](<HanaCAFE nappa69 プロジェクト仕様書.md>) | **★ SSOT** — 全体像（階層図・データ構造・FLOCSS設計） | 1.3.0 |
| [アーキテクチャ設計.md](アーキテクチャ設計.md) | 実装ガイドライン・ディレクトリ構造詳細 | 1.0.0 |
| [コーディング規約.md](コーディング規約.md) | PHP / SCSS / JS の記述ルール・環境定義 | 1.0.0 |
| [CMS運用マニュアル.md](CMS運用マニュアル.md) | 管理画面での日常操作（メニュー・席情報更新） | 1.4.1 |
| [本番移行手順書.md](本番移行手順書.md) | デプロイ手順・環境切替マニュアル | 1.0.1 |
| [品質チェックリスト.md](品質チェックリスト.md) | 公開前後の動作確認項目 | 3.3.1 |
